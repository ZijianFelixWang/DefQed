...
namespace DefQed.Core
{
    public class KBase : IDisposable
    {
        ...
        // Pools
        private List<MicroStatement> leftPool = new();   // Pool generated by conditions
        private List<MicroStatement> rightPool = new();  // Pool generated by conclusions
        ...
        public List<MicroStatement> RightPool { get => rightPool; set => rightPool = value; }
        public List<MicroStatement> LeftPool { get => leftPool; set => leftPool = value; }
